...
public class UserService {
	...
	public ResponseEntity<User> save(HttpServletResponse response, @RequestParam(name = "name") String name,
			@RequestParam(name = "description") String description,
			@RequestParam(name = "permissions") List<Long> permissionIds) {

		Set<Permission> permissions = permissionRepository.findAllByIdIn(permissionIds);
		User user = new User(name, description, permissions);
	...
	public ResponseEntity<?> update(HttpServletResponse response, @RequestParam("id") Long id,
	...
	public ResponseEntity<?> delete(HttpServletResponse response, @RequestParam("id") Long id) {
	...
	// @ResponseStatus(HttpStatus.OK)
	// @RequestMapping(value = "/users/add/permission", method =
	// RequestMethod.POST)
	...
	public ResponseEntity<?> addDepartment(HttpServletResponse response, @RequestParam("userId") Long userId,
